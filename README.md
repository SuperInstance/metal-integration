...
Integration tests proving all 12 Rust metal libraries work together as a coherent system
...
```bash
git clone https://github.com/SuperInstance/metal-integration
cd metal-integration
```
